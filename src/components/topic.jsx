...
export default function Topic(props){
    ...
    return(
        <div className="w-[130px] h-[120px] m-2 bg-black  sha2 p-2   active:tracking-tight hover:border-2 border-yellow-600  md:transition-all md:ease-in md:duration-100 ">
