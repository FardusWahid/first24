...
<div className="flex justify-center w-full">
  <button className="py-3 bg-black flex justify-center font-mono tracking-tighter font-bold text-[16px] lg:text-[20px] items-center" onClick={copyToClipboard}>I am ready to pay 499 with Bkash&nbsp;<FaCopy size={25} color="gray" /></button>
  </div>
