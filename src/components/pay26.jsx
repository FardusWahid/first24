...
export default function H26() {


  
    const copyToClipboard = () => {
      navigator.clipboard.writeText("I am ready to pay 299 with Bkash [hsc26]")
...
<div className="flex justify-center w-full">
  <button className="py-3 bg-black flex justify-center font-mono tracking-tighter font-bold text-[16px] lg:text-[20px] items-center" onClick={copyToClipboard}>I am ready to pay 299 with Bkash&nbsp;<FaCopy size={25} color="gray" /></button>
  </div>
